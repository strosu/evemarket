...
namespace IO.Swagger.Api
{
    ...
    public partial class RoutesApi : IRoutesApi
    {
        ...
        public ApiResponse< List<int?> > GetRouteOriginDestinationWithHttpInfo (int? destination, int? origin, List<int?> avoid = null, List<List<int?>> connections = null, string datasource = null, string flag = null, string ifNoneMatch = null)
        {
            ...
            if (origin != null) localVarPathParams.Add("origin", Configuration.ApiClient.ParameterToString(origin)); // path parameter
            if (avoid != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("multi", "avoid", avoid)); // query parameter
            if (connections != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("multi", "connections", connections)); // query parameter
            ...
            if (flag != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "flag", flag)); // query parameter
