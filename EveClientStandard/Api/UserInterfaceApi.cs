...
namespace IO.Swagger.Api
{
    ...
    public partial class UserInterfaceApi : IUserInterfaceApi
    {
        ...
        public ApiResponse<Object> PostUiAutopilotWaypointWithHttpInfo (bool? addToBeginning, bool? clearOtherWaypoints, long? destinationId, string datasource = null, string token = null)
        {
            ...
            if (addToBeginning != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "add_to_beginning", addToBeginning)); // query parameter
            if (clearOtherWaypoints != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "clear_other_waypoints", clearOtherWaypoints)); // query parameter
            ...
            if (destinationId != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "destination_id", destinationId)); // query parameter
        ...
        public ApiResponse<Object> PostUiOpenwindowContractWithHttpInfo (int? contractId, string datasource = null, string token = null)
        {
            ...
            if (contractId != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "contract_id", contractId)); // query parameter
            if (datasource != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "datasource", datasource)); // query parameter
            if (token != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "token", token)); // query parameter
        ...
        public ApiResponse<Object> PostUiOpenwindowInformationWithHttpInfo (int? targetId, string datasource = null, string token = null)
        {
            ...
            if (datasource != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "datasource", datasource)); // query parameter
            if (targetId != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "target_id", targetId)); // query parameter
            if (token != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "token", token)); // query parameter
