...
namespace IO.Swagger.Api
{
    ...
    public partial class ContactsApi : IContactsApi
    {
        ...
        public ApiResponse<Object> DeleteCharactersCharacterIdContactsWithHttpInfo (int? characterId, List<int?> contactIds, string datasource = null, string token = null)
        {
            ...
            if (contactIds != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("multi", "contact_ids", contactIds)); // query parameter
        ...
        public ApiResponse< List<GetAlliancesAllianceIdContacts200Ok> > GetAlliancesAllianceIdContactsWithHttpInfo (int? allianceId, string datasource = null, string ifNoneMatch = null, int? page = null, string token = null)
        {
            ...
            return new ApiResponse<List<GetAlliancesAllianceIdContacts200Ok>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<GetAlliancesAllianceIdContacts200Ok>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<GetAlliancesAllianceIdContacts200Ok>)));
        }
        ...
        public ApiResponse< List<GetAlliancesAllianceIdContactsLabels200Ok> > GetAlliancesAllianceIdContactsLabelsWithHttpInfo (int? allianceId, string datasource = null, string ifNoneMatch = null, string token = null)
        {
            ...
            return new ApiResponse<List<GetAlliancesAllianceIdContactsLabels200Ok>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<GetAlliancesAllianceIdContactsLabels200Ok>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<GetAlliancesAllianceIdContactsLabels200Ok>)));
        }
        ...
        public ApiResponse< List<GetCorporationsCorporationIdContacts200Ok> > GetCorporationsCorporationIdContactsWithHttpInfo (int? corporationId, string datasource = null, string ifNoneMatch = null, int? page = null, string token = null)
        {
            ...
            return new ApiResponse<List<GetCorporationsCorporationIdContacts200Ok>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<GetCorporationsCorporationIdContacts200Ok>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<GetCorporationsCorporationIdContacts200Ok>)));
        }
        ...
        public ApiResponse< List<GetCorporationsCorporationIdContactsLabels200Ok> > GetCorporationsCorporationIdContactsLabelsWithHttpInfo (int? corporationId, string datasource = null, string ifNoneMatch = null, string token = null)
        {
            ...
            return new ApiResponse<List<GetCorporationsCorporationIdContactsLabels200Ok>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<GetCorporationsCorporationIdContactsLabels200Ok>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<GetCorporationsCorporationIdContactsLabels200Ok>)));
        }
        ...
        public ApiResponse< List<int?> > PostCharactersCharacterIdContactsWithHttpInfo (int? characterId, List<int?> contactIds, float? standing, string datasource = null, List<long?> labelIds = null, string token = null, bool? watched = null)
        {
            ...
            if (characterId != null) localVarPathParams.Add("character_id", Configuration.ApiClient.ParameterToString(characterId)); // path parameter
            if (datasource != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "datasource", datasource)); // query parameter
            if (labelIds != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("multi", "label_ids", labelIds)); // query parameter
            if (standing != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "standing", standing)); // query parameter
            if (token != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "token", token)); // query parameter
            if (watched != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "watched", watched)); // query parameter
