...
namespace IO.Swagger.Model
{
    ...
    public partial class GetAlliancesAllianceIdContacts200Ok :  IEquatable<GetAlliancesAllianceIdContacts200Ok>, IValidatableObject
    {
        ...
        public GetAlliancesAllianceIdContacts200Ok(int? ContactId = default(int?), ContactTypeEnum ContactType = default(ContactTypeEnum), List<long?> LabelIds = default(List<long?>), float? Standing = default(float?))
        {
