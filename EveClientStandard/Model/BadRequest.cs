...
namespace IO.Swagger.Model
{
    ...
    public partial class BadRequest :  IEquatable<BadRequest>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="BadRequest" /> class.
        /// </summary>
        /// <param name="Error">Bad request message (required).</param>
        public BadRequest(string Error = default(string))
        {
            // to ensure "Error" is required (not null)
            if (Error == null)
            {
                throw new InvalidDataException("Error is a required property for BadRequest and cannot be null");
            }
            else
            {
                this.Error = Error;
