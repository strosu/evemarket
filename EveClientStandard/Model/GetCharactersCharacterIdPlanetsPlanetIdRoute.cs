...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdPlanetsPlanetIdRoute :  IEquatable<GetCharactersCharacterIdPlanetsPlanetIdRoute>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdPlanetsPlanetIdRoute(int? ContentTypeId = default(int?), long? DestinationPinId = default(long?), float? Quantity = default(float?), long? RouteId = default(long?), long? SourcePinId = default(long?), List<long?> Waypoints = default(List<long?>))
        {
